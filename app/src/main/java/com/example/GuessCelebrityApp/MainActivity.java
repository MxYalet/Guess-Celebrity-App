...
public class MainActivity extends AppCompatActivity {
    ...
    //Async task class for downloading the web images
    ...
    //Async task class for downloading the web page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String[] splitResult = result.split("<div class = \"lister-item-content\">");
            Pattern p = Pattern.compile("src=\"(.*?)AL .jpg\"");
